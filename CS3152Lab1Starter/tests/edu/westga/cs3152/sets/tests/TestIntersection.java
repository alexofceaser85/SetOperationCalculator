...
class TestIntersection {
	...
	@Test
	public void shouldNotFindIntersectionOfTwoSetsIfInputtedSetIsNull() {
		...
		assertEquals(message, SortedSetErrorMessages.CANNOT_FIND_THE_INTERSECTION_OF_THE_SET_AND_THE_INPUTTED_SET_IF_THE_INPUTTED_SET_IS_NULL);
	}
	
	@Test
	public void shouldNotFindIntersectionOfTwoSetsIfInputtedSetIsNotASortedSet() {
		SortedSet<String> firstSet = new SortedSet<String>();
		
		String message = assertThrows(ClassCastException.class, () -> {
			firstSet.intersection(new MockSet<String>());
		}).getMessage();
		
		assertEquals(message, SortedSetErrorMessages.CANNOT_FIND_THE_INTERSECTION_OF_THE_SET_AND_THE_INPUTTED_SET_IF_THE_INPUTTED_SET_IS_NOT_A_SORTED_SET);
	}
